...
import { ChevronLeft, ChevronRight, Plus, ScanLine, Heart, Eye, Loader2 } from 'lucide-react';
...
const ProductSection: React.FC = () => {
  ...
  // Fetch products from "WordPress" on load
  useEffect(() => {
  ...
  return (
    <section id="shop" className="relative py-24 z-10 overflow-hidden bg-black/90 min-h-[800px]">
      ...
      {loading ? (
        <div className="flex items-center justify-center h-[400px]">
          <Loader2 className="w-12 h-12 text-morco-blue animate-spin" />
          <span className="ml-4 font-mono text-sm uppercase tracking-widest">Initializing Armory...</span>
        </div>
      ) : (
        /* Carousel */
        <div 
